...
def bias_spectr(com, par, data_folder, basename = '%Y%m%d_'):
    ...
    com.BiasSpectrChsSet(*par['BiasSpectrChs'].values.tolist())
...
# print('done')
bias_par = bias_spectr_par_load('C:/Personal_files/Study/Python_scripts/GitHub/Scripts/', 'BiasSpectr_Fe.par')
print(*bias_par['BiasSpectrAdvProps'].values.tolist())
print(*bias_par['BiasSpectrAdvProps'].values)
connect.BiasSpectrAdvPropsSet(*bias_par['BiasSpectrAdvProps'].values)
connect.BiasSpectrAdvPropsSet(*bias_par['BiasSpectrAdvProps'].values.tolist( ))
# connect.BiasSpectrChsSet(3, [0,1,2])
