...
dtype_cvt_dict = defaultdict(lambda:
                                {
                                # to binary
                                (infmt=='1dstr' or infmt =='str', outfmt=='bin'): np.array(data, dtype = '>S').tobytes(),
                                (infmt=='int' or infmt=='1dint'                       , outfmt=='bin'): lambda: np.array(data, dtype = '>i').tobytes(),
                                })

print(dtype_cvt_dict[infmt, outfmt])
