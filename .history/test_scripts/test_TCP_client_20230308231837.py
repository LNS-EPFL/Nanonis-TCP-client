...
# create a 1D array of fixed-length strings using numpy.array()
str_array = np.array(str_list, dtype='>S')

# convert the array to bytes using tobytes()
bytes_data = str_array.tobytes()
