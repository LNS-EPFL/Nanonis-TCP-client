...
string = np.array([2.55, 3.265, 456.4598])
a= np.array(string, dtype = '>f').tobytes()
print(dtype_convert(2.55, 'float32', 'bin'))
print(dtype_convert(3.265, 'float32', 'bin'))
print(dtype_convert(456.4598, 'float32', 'bin'))
print(a)
