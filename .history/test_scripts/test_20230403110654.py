...
print(*bias_par['BiasSpectrChs'].values) #bias_par['BiasSpectrChs'].values[0]

# connect.BiasSpectrChsSet(*bias_par['BiasSpectrChs'].values)
# connect.BiasSpectrChsSet(3, [np.array([ 0, 24, 27])])
# data, _ = bias_spectr(connect, bias_par, 'FER')
np.array([np.array([0,27,38])], '>i').tobytes()
