...
def data_type_converter(original_fmt, target_fmt, data):
    data_type_convert = defaultdict({
                                    (original_fmt == 'hex' and target_fmt == '' ):'AA',
                                    (original_fmt == 'hex' and target_fmt == '' ): 'BB',
                                    (original_fmt == 'hex' and target_fmt == '' ): 'CC',
                                    (original_fmt == 'hex' and target_fmt == '' ): 'DD',
                                    (original_fmt == 'hex' and target_fmt == '' ): 'EE',
                                    (original_fmt == 'hex' and target_fmt == '' ): 'FF',
                                    (original_fmt == '' and target_fmt == 'hex' ): 'GG',
                                    (original_fmt == '' and target_fmt == 'hex' ): 'II',
                                    (original_fmt == '' and target_fmt == 'hex' ):'AA',
                                    (original_fmt == '' and target_fmt == 'hex' ): 'BB',
                                    (original_fmt == '' and target_fmt == 'hex' ): 'CC',
                                    (original_fmt == '' and target_fmt == 'hex' ): 'DD',
