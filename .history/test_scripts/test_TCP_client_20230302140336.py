...
def data_type_converter(original_fmt, target_fmt, data):
    data_type_convert = defaultdict(lambda:
                                    {
                                    (original_fmt == 'hex'     and target_fmt == 'str'     ): 'a',
                                    (original_fmt == 'hex'     and target_fmt == 'int'     ): 'a',
                                    (original_fmt == 'hex'     and target_fmt == 'uint16'  ): 'a',
                                    (original_fmt == 'hex'     and target_fmt == 'uint32'  ): 'a',
                                    (original_fmt == 'hex'     and target_fmt == 'float32' ): 'a',
                                    (original_fmt == 'hex'     and target_fmt == 'float64' ): 'a',
                                    (original_fmt == 'str'     and target_fmt == 'hex'     ): 'a',
                                    (original_fmt == 'int'     and target_fmt == 'hex'     ): 'a',
                                    (original_fmt == 'uint16'  and target_fmt == 'hex'     ): 'a',
                                    (original_fmt == 'uint32'  and target_fmt == 'hex'     ): 'a',
                                    (original_fmt == 'float32' and target_fmt == 'hex'     ): 'a',
                                    (original_fmt == 'float64' and target_fmt == 'hex'     ): 'a',
...
print(struct.unpack("<h",struct.pack("H",int("0x"+'3E45 798E E230 8C3A'.hex(),16)))[0])