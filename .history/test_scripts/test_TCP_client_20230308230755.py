...
dtype_cvt_dict = defaultdict(lambda: None, {
        (inn == '1dstr' or 'str' and out =='bin'): lambda data: np.array(data, dtype = '>S').tobytes(),
        (inn == '1dint' or 'int' and out =='bin'): lambda data: np.array(data, dtype = '>i').tobytes(),
    })


value = dtype_cvt_dict[inn, out](data)
print(value)
