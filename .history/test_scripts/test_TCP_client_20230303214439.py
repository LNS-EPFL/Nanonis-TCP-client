...
def data_type_converter(original_fmt, target_fmt, data):
    ...
    if original_fmt in supported_formats and target_fmt in supported_formats:
        ...
        print("TyPeError: Please check the data formats! Supported data formats are: 'int', 'uint16', 'uint32', 'float32', 'float64', 'hex', 'str'")
...
supported_formats = ['int', 'uint16', 'uint32', 'float32', 'float64', 'hex', 'str']
data = 4
print(data_type_converter(original_fmt, target_fmt, data))