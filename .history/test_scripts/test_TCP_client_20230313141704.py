...
my_list = ['float', '1duint32', 'int', '1dint', '1duint32', '1dfloat32', '1dfloat64', '2dfloat32']
last_index = len(my_list) - 1 - next(i for i, x in enumerate(reversed(my_list)) if not x.startswith('1d') and not x.startswith('2d'))
print(last_index)