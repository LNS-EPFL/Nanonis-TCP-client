...
######################################## Tip Shaper Module #############################################
    ...
    def TipShaperPropsGet(self):
        ...
        tip_shaper_props_df = pd.DataFrame({'Switch off delay (s)': res_arg[0],
                                            ...
                                            'Bias (V)': res_arg[],
                                            'Tip lift (m)': res_arg[],
                                            'Lift time 1 (s)': res_arg[],
                                            'Bias lift (V)': res_arg[],
                                            'Bias settling time (s)': res_arg[],
                                            'Lift height (m)': res_arg[],
                                            'Lift time 2 (s)': res_arg[],
                                            'End wait time (s)': res_arg[],
                                            'Restore feedback': res_arg[],
                                            },
                                 index=[0]).T
        print('\n'+
              tip_shaper_props_df.to_string(header=False)+
