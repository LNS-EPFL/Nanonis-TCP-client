    ...
    def res_recv(self, *varg_fmt, get_header = True, get_arg = True, get_err = True):
        ...
        if get_arg:
            ...
            for idx, arg_fmt in enumerate(varg_fmt):
                if arg_fmt == 'str':
                    arg_size = arg_size_dict['int'] # the strings have a variable size which is always prepended as an integer 32.
                    str_size = self.dtype_convert(res_bin_rep[arg_byte_idx: arg_byte_idx + arg_size])
