...
#################### basic functions for creating commands ####################
    ...
    def dtype_cvt_v2(self, data, original_fmt, target_fmt): # data_size is the length of an 1d array (8 for example)or the number of rows and columns of a 2d array ([2,2] for example) 
        supported_formats = ['bin', 'str', 'int', 'uint16', 'uint32', 'float32', 'float64']
        dtype_cvt_dict = defaultdict(lambda: None, 
                                     {
                                     # to binary
