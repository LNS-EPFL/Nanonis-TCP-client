...
#################### basic functions for creating commands ####################
    ...
    def dtype_cvt(self, data, original_fmt, target_fmt, *arg):  
        ...
        #! binary to 1d string
        elif original_fmt == 'bin' and target_fmt == '1dstr': 
        ...
        #* binary to float64
        elif original_fmt == 'bin' and target_fmt == 'float64': 
        np.frombuffer(data, '>d')

        elif original_fmt in supported_dtypes and target_fmt in supported_dtypes:
            try:
