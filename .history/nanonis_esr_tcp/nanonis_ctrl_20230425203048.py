...
######################################## Bias Module #############################################
    ...
    def BiasRangeSet(, prt = False): 
        return print('function in progress......')
    
    def BiasRangeGet(, prt = False):
        return print('function in progress......')
    
    def BiasCalibrSet(, prt = False):
        return print('function in progress......')

    def BiasCalibrGet(, prt = False):
        return print('function in progress......')
    
    def BiasPulse(self, wait_until_done, bias_pulse_width, bias_value, zctrl_on_hold, pulse_abs_rel, prt = False):
...
######################################## Bias Spectroscopy Module #############################################
    def BiasSpectrOpen(self, prt = False):
    ...
    def BiasSpectrStart(self, get_data, save_base_name, prt = False):
    ...
    def BiasSpectrStop(self, prt = False):
    ...
    def BiasSpectrStatusGet(self, prt = False):
    ...
    def BiasSpectrChsSet(self, num_chs, ch_idx, prt = False):
    ...
    def BiasSpectrChsGet(self, prt = False):
    ...
    def BiasSpectrPropsSet(self, save_all, num_sweeps, bw_sweep, num_pts, z_offset, auto_save, show_save_dialog, prt = False):
    ...
    def BiasSpectrPropsGet(self, prt = False):
    ...
    def BiasSpectrAdvPropsSet(self, reset_bias, z_ctrl_hold, rec_final_z, lock_in_run, prt = False):
    ...
    def BiasSpectrAdvPropsGet(self, prt = False):
    ...
    def BiasSpectrLimitsSet(self, start_val, end_val, prt = False):
    ...
    def BiasSpectrLimitsGet(self, prt = False):
    ...
    def BiasSpectrTimingSet(self, z_avg_t, z_offset, init_settling_t, max_slew_rate, settling_t, inte_t, end_settling_t, z_ctrl_t, prt = False):
    ...
    def BiasSpectrTimingGet(self, prt = False):
    ...
    def BiasSpectrTTLSyncSet(self, enable, ttl_line, ttl_polarity, t_2_on, on_duration, prt = False):
    ...
    def BiasSpectrTTLSyncGet(self, prt = False):
    ...
    def BiasSpectrAltZCtrlSet(self, alt_z_ctrl_sp, sp, settling_t, prt = False):
    ...
    def BiasSpectrAltZCtrlGet(self, prt = False):
    ...
    def BiasSpectrMLSLockinPerSegSet(self, lockin_per_seg, prt = False):
    ...
    def BiasSpectrMLSLockinPerSegGet(self, prt = False):
    ...
    def BiasSpectrMLSModeSet(self, sweep_mode, prt = False):
    ...
    def BiasSpectrMLSModeGet(self, prt = False):
    ...
    def BiasSpectrMLSValsSet(self, num_segs, bias_start, bias_end, init_settling_t, settling_t, inte_t, steps, lockin_run, prt = False):
    ...
    def BiasSpectrMLSValsGet(self, prt = False):
...
######################################## Current Module #############################################
    ...
    def Current100Get(self, prt = False):
        return

    def CurrentBEEMGet(self, prt = False):
        return

    def CurrentGainSet(self, prt = False):
        return

    def CurrentGainsGet(self, prt = False):
        return

    def CurrentCalibrSet(self, prt = False):
        return

    def CurrentCalibrGet(self, prt = False):
...
######################################## Z-controller Module #############################################
    def ZCtrlZPosSet(self, z_pos, prt = False):
    ...
    def ZCtrlZPosGet(self, prt = False):
    ...
    def ZCtrlOnOffSet(self, z_ctrl_status, prt = False):
    ...
    def ZCtrlOnOffGet(self, prt = False):
    ...
    def ZCtrlSetpntSet(self, z_ctrl_sp, prt = False):
    ...
    def ZCtrlSetpntGet(self, prt = False):
    ...
    def ZCtrlGainSet(self, prt = False):
        return
          
    def ZCtrlGainGet(self, prt = False):
        return
          
    def ZCtrlSwitchOffDelaySet(self, prt = False):
        return

    def ZCtrlSwitchOffDelayGet(self, prt = False):
        return

    def ZCtrlTipLiftSet(self, prt = False):
        return

    def ZCtrlTipLiftGet(self, prt = False):
        return

    def ZCtrlHome(self, prt = False):
        return

    def ZCtrlHomePropsSet(self, prt = False):
        return

    def ZCtrlHomePropsGet(self, prt = False):
        return

    def ZCtrlActiveCtrlSet(self, prt = False):
        return

    def ZCtrlCtrlListGet(self, prt = False):
        return

    def ZCtrlWithdraw(self, prt = False):
        return

    def ZCtrlWithdrawRateSet(self, prt = False):
        return

    def ZCtrlWithdrawRateGet(self, prt = False):
        return

    def ZCtrlLimitsEnabledSet(self, prt = False):
        return

    def ZCtrlLimitsEnabledGet(self, prt = False):
        return

    def ZCtrlLimitsSet(self, prt = False):
        return

    def ZCtrlLimitsGet(self, prt = False):
        return

    def ZCtrlStatusGet(self, prt = False):
        return

######################################## Safe Tip Module #############################################
######################################## Auto Approach Module #############################################
######################################## Scan Module #############################################
    def ScanAction(self, scan_act, scan_dir, prt = False):
    ...
    def ScanStatusGet(self, prt = False):
    ...
    def ScanWaitEndOfScan(self, timeout, prt = False):
    ...
    def ScanFrameSet(self, center_x, center_y, w, h, angle, prt = False):
    ...
    def ScanFrameGet(self, prt = False):
    ...
    def ScanBufferSet(self, num_chs, ch_idx, px, lines, prt = False):
        body  = self.tcp.dtype_cvt(num_chs, 'int', 'bin')
        body += self.tcp.dtype_cvt(ch_idx, '1dint', 'bin')
    ...
    def ScanBufferGet(self, prt = False):
        return

    def ScanPropsSet(self, prt = False):
        return

    def ScanPropsGet(self, prt = False):
        return

    def ScanSpeedSet(self, prt = False):
        return

    def ScanSpeedGet(self, prt = False):
        return

    def ScanFrameDataGrab(self, prt = False):
        return

######################################## Follow Me Module #############################################
######################################## Tip Shaper Module #############################################
    def TipShaperStart(self, wait_until_fin, timeout, prt = False):
        timeout = int(self.tcp.unit_cvt(timeout)*1000)
    ...
    def TipShaperPropsSet(self, switch_off_delay, change_bias, bias, tip_lift, lift_t1, bias_lift, bias_settling_t, lift_h, lift_t2, end_wait_t, restore_feedback, prt = False):
    ...
    def TipShaperPropsGet(self, prt = False):
...
######################################## Generic Sweeper Module #############################################
    def GenSwpAcqChsSet(self, num_chs, ch_idx, prt = False):
        body  = self.tcp.dtype_cvt(num_chs, 'int', 'bin')
        body += self.tcp.dtype_cvt(ch_idx, '1dint', 'bin')
    ...
    def GenSwpAcqChsGet(self, prt = False):
    ...
    def GenSwpSwpSignalSet(self, swp_ch_name_size, swp_ch_name, prt = False):
    ...
    def GenSwpSwpSignalGet(self, prt = False):
    ...
    def GenSwpLimitsSet(self, lo_lmt, up_lmt, prt = False):
    ...
    def GenSwpLimitsGet(self, prt = False):
    ...
    def GenSwpPropsSet(self, init_settling_t, max_slew_rate, num_steps, periods, autosave, save_dialog, settling_t, prt = False):
    ...
    def GenSwpPropsGet(self, prt = False):
    ...
    def GenSwpStart(self, get_data, sweep_dir, save_base_name, reset_signal, prt = False):
...
######################################## Atom Tracking Module #############################################
    def AtomTrackCtrlSet(self, at_ctrl, status, prt = False): #Modulation: 0; Controller: 1; Drift measurement:2
    ...
    def AtomTrackStatusGet(self, at_ctrl, prt = False):
        body  = self.tcp.dtype_cvt(at_ctrl, 'uint16', 'bin')
    ...
    def AtomTrackPropsSet(self, inte_gain, freq, ampl, phase, switch_off_delay, prt = False):
    ...
    def AtomTrackPropsGet(self, prt = False):
    ...
    def AtomTrackQuickCompStart(self, prt = False):
        return

    def AtomTrackDriftComp(self, prt = False):
        return

######################################## Lock-in Module #############################################
    def LockInModOnOffSet(self, modu_num, lockin_onoff, prt = False):
    ...
    def LockInModOnOffGet(self, modu_num, prt = False):
        body  = self.tcp.dtype_cvt(modu_num, 'int', 'bin')
    ...
    def LockInModSignalSet(self, prt = False):
        return

    def LockInModSignalGet(self, prt = False):
        return

    def LockInModPhasRegSet(self, prt = False):
        return

    def LockInModPhasRegGet(self, prt = False):
        return

    def LockInModHarmonicSet(self, prt = False):
        return

    def LockInModHarmonicGet(self, prt = False):
        return

    def LockInModPhasSet(self, modu_num, phase, prt = False):
        body  = self.tcp.dtype_cvt(modu_num, 'int', 'bin')
        body += self.tcp.dtype_cvt(phase, 'float32', 'bin')
    ...
    def LockInModPhasGet(self, prt = False):
        return

    def LockInModAmpSet(self, modu_num, ampl, prt = False):
        ampl = self.tcp.unit_cvt(ampl)
    ...
    def LockInModAmpGet(self, modu_num, prt = False):
        body  = self.tcp.dtype_cvt(modu_num, 'int', 'bin')
    ...
    def LockInModPhasFreqSet(self, modu_num, freq, prt = False):
        freq = self.tcp.unit_cvt(freq)
    ...
    def LockInModPhasFreqGet(self, modu_num, prt = False):
        body  = self.tcp.dtype_cvt(modu_num, 'int', 'bin')
    ...
    def LockInDemodSignalSet(self, prt = False):
        return

    def LockInDemodSignalGet(self, prt = False):
        return

    def LockInDemodHarmonicSet(self, prt = False):
        return

    def LockInDemodHarmonicGet(self, prt = False):
        return

    def LockInDemodHPFilterSet(self, prt = False):
        return

    def LockInDemodHPFilterGet(self, prt = False):
        return

    def LockInDemodLPFilterSet(self, prt = False):
        return

    def LockInDemodLPFilterGet(self, prt = False):
        return

    def LockInDemodPhasRegSet(self, prt = False):
        return

    def LockInDemodPhasRegGet(self, prt = False):
        return

    def LockInDemodPhasSet(self, prt = False):
        return

    def LockInDemodPhasGet(self, prt = False):
        return

    def LockInDemodSyncFilterSet(self, prt = False):
        return

    def LockInDemodSyncFilterGet(self, prt = False):
        return

    def LockInDemodRTSignalsSet(self, prt = False):
        return

    def LockInDemodRTSignalsGet(self, prt = False):
        return
######################################## Signals Module #############################################
    def SignalsNamesGet(self, prt = False):
...
######################################## Utilities Module #############################################
    def UtilSessionPathGet(self, prt = False):
    ...
    def UtilSessionPathSet(self, sess_path, save_settings_to_prev, prt = False):
    ...
    def UtilSettingsLoad(self, prt = False):

        return

    def UtilSettingsSave(self, prt = False):

        return

    def UtilLayoutLoad(self, prt = False):

        return

    def UtilLayoutSave(self, prt = False):

        return

    def UtilLock(self, prt = False):

        return

    def UtilUnLock(self, prt = False):

        return

    def UtilRTFreqSet(self, prt = False):

        return

    def UtilRTFreqGet(self, prt = False):

        return

    def UtilAcqPeriodSet(self, prt = False):

        return

    def UtilAcqPeriodGet(self, prt = False):

        return

    def UtilRTOversamplSet(self, prt = False):

        return

    def UtilRTOversamplGet(self, prt = False):

        return

    def UtilQuit(self, prt = False):
