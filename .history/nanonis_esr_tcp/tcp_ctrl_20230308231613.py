...
#################### basic functions for creating commands ####################
    ...
    def dtype_cvt(self, data, original_fmt, target_fmt): # data_size is the length of an 1d array (8 for example)or the number of rows and columns of a 2d array ([2,2] for example) 
        ...
        dtype_cvt_dict = defaultdict(lambda: 
                                     ...
                                     # to binary
                                      ...
                                      (original_fmt == 'bin' and target_fmt == 'int'    ): np.frombuffer(data, '>i'), 
                                      (original_fmt == 'bin' and target_fmt == 'uint16' ): np.frombuffer(data, '>H'),
                                      (original_fmt == 'bin' and target_fmt == 'uint32' ): np.frombuffer(data, '>L'),
                                      (original_fmt == 'bin' and target_fmt == 'float32'): np.frombuffer(data, '>f'),
    ...
    def array_dtype_cvt(self, data, original_fmt, target_fmt, array_size): # array size can be a integer like 7 (for 1d arrays) or a list [7,8] (for 2d arrays)
        supported_dtypes = ['bin', '1dstr', '1dint32', '1duint32', '1dfloat32', '1dfloat64', '2dfloat32', '2dstr']
