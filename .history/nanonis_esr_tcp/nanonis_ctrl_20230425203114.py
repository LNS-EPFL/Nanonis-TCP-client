...
######################################## Bias Module #############################################
    ...
    def BiasRangeSet(, prt_df = False): 
        return print('function in progress......')
    
    def BiasRangeGet(, prt_df = False):
        return print('function in progress......')
    
    def BiasCalibrSet(, prt_df = False):
        return print('function in progress......')

    def BiasCalibrGet(, prt_df = False):
        return print('function in progress......')
...
######################################## Scan Module #############################################
    ...
    def ScanPropsSet(self, prt_df = False):
        return

    def ScanPropsGet(self, prt_df = False):
        return

    def ScanSpeedSet(self, prt_df = False):
        return
