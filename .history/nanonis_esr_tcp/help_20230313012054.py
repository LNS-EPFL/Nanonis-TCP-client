...
class MyClass:
    ...
    def non_func_attr(self):
        pass

# Get all the attributes of the MyClass class
attrs = dir(MyClass)

# Filter out only the callable attributes (i.e., functions)
funcs = [attr for attr in attrs if callable(getattr(MyClass, attr))]
