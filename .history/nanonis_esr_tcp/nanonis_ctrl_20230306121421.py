...
class nanonis_ctrl:
    ...
    def BiasSet(self, bias):
        ...
        self.tcp.res_recv()
        print(f'Bias voltage is set to {bias}V')
    ...
    def BiasGet(self):
        ...
        bias = str(self.tcp.res_recv('float32')[0][0]) + 'V' # first [0] gives the res_arg list, second [0] gives the bias value in the list
        return bias
