...
#################### basic functions for creating commands ####################
    ...
    # ! data type conversion. *arg is for 2d array conversions. arg should be a tuple in the form of (num_rows, num_cols), eg. (41, 2)
    def dtype_cvt(self, data, original_fmt, target_fmt, *arg):  
        ...
        dtype_cvt_dict = defaultdict(lambda: 
                                     ...
                                     # to binary
                                      ...
                                      (original_fmt == 'bin' and target_fmt == '1dstr'                 ): [].append(np.frombuffer(data, '>%dS' % len(data))),
