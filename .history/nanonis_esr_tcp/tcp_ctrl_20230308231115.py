    ...
    def dtype_cvt(self, data, original_fmt, target_fmt): # data_size is the length of an 1d array (8 for example)or the number of rows and columns of a 2d array ([2,2] for example) 
        ...
        dtype_cvt_dict = defaultdict(lambda: 
                                     ...
                                     # to binary
                                      ...
                                      # from binary
                                      ('bin', 'str'    ): np.frombuffer(data, '>%dS' % len(data)),
                                      ('bin', 'int'    ): np.frombuffer(data, '>i'), 
                                      ('bin', 'uint16' ): np.frombuffer(data, '>H'),
                                      ('bin', 'uint32' ): np.frombuffer(data, '>L'),
                                      ('bin', 'float32'): np.frombuffer(data, '>f'),
                                      ('bin', 'float64'): np.frombuffer(data, '>d')
                                     })
