...
#################### basic functions for creating commands ####################
    ...
    def dtype_convert(self, data, original_fmt, target_fmt, data_size = None): # ! data_size is the length of an 1d array or the number of rows and columns of a 2d array  
