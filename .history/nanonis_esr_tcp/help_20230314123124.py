...
Arguments:
- Enable (unsigned int16) selects whether the feature is active or not. 0 means no change, 1 means On, and 2
means Off
- TTL line (unsigned int16) sets which digital line should be controlled. 0 means no change, 1 means HS
Line 1, 2 means HS Line 2, 3 means HS Line 3, 4 means HS Line 4
- TTL polarity (unsigned int16) sets the polarity of the switching action. 0 means no change, 1 means Low
Active, and 2 means High Active
