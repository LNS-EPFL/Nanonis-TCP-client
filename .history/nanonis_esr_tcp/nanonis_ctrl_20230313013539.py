...
######################################## Bias Spectroscopy Module #############################################
    ...
    def BiasSpectrTimingSet(self, z_avg_t, z_offset_t, init_settling_t, max_slew_rate, settling_t, int_t, end_settling_t, z_ctrl_t):
        z_avg_t = self.tcp.unit_cvt(z_avg_t)
        z_offset_t = self.tcp.unit_cvt(z_offset_t)
        ...
        body  = self.tcp.dtype_cvt(z_avg_t, 'uint32', 'bin')
        body += self.tcp.dtype_cvt(z_offset_t, 'uint32', 'bin')
        body += self.tcp.dtype_cvt(init_settling_t, 'uint32', 'bin')
        body += self.tcp.dtype_cvt(max_slew_rate, 'uint32', 'bin')
        body += self.tcp.dtype_cvt(settling_t, 'uint32', 'bin')
        body += self.tcp.dtype_cvt(int_t, 'uint32', 'bin')
        body += self.tcp.dtype_cvt(end_settling_t, 'uint32', 'bin')
        body += self.tcp.dtype_cvt(z_ctrl_t, 'uint32', 'bin')
